...
export type ArrayTernaryPred<T, Ind = number | string, FtrT extends Slice<T>> = (x: T, i?: Ind, xs?: FtrT) => boolean;
...
export type PredForSlice<T = any, T2 extends Slice<T>> = ArrayTernaryPred<T, number | string, T2>;

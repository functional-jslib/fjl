...
export const
   ...
   */
  findIndexWhereRight = <T>(pred: PredForSlice<T>, arr: Slice<T>): number => {
   ...
   */
  $findIndexWhereRight = curry(findIndexWhereRight) as CurryOf2<PredForSlice<any>, Slice<any>, number>

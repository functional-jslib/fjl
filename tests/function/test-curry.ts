import {curry, curry2, curry3, curry4, curry5, curryN} from '../../src/function';
import {alphabetArray} from '../helpers';
import {NaryOf} from "../../src/types";

describe('#curryN', () => {
    // Some funcs to use in tests
    const recursiveBinOp = (op, start): NaryOf<number, number> =>
            (...args: number[]) => args.reduce((a, b) => {
                return op(a, b);
            }, start),

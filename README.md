...
- [(m) fjl.id](#m-fjlid)
- [(m) fjl.equals](#m-fjlequals)
- [(m) fjl.concat](#m-fjlconcat)
- [(m) fjl.of](#m-fjlof)
- [(m) fjl.empty](#m-fjlempty)
- [(m) fjl.zero](#m-fjlzero)
- [(m) fjl.ap](#m-fjlap)
- [(m) fjl.alt](#m-fjlalt)
- [(m) fjl.map](#m-fjlmap)
- [(m) fjl.filter](#m-fjlfilter)
- [(m) fjl.reduce](#m-fjlreduce)
- [(m) fjl.reduceRight](#m-fjlreduceright)
- [(m) fjl.join](#m-fjljoin)
- [(m) fjl.chain](#m-fjlchain)
- [(m) fjl.liftN](#m-fjlliftn)
- [(m) fjl.extend](#m-fjlextend)
- [(m) fjl.extract](#m-fjlextract)
- [(m) fjl.promap](#m-fjlpromap)
- [(m) fjl.bimap](#m-fjlbimap)

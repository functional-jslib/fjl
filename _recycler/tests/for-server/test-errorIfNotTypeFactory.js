...
import {curry, curry2} from '../../../src/_functionOps/curry';
...
describe('errorIfNotTypeFactory', function () {
    ...
    it ('should return a _functionOps that when fired with error condition should include the shared contextName.', function () {
    ...
    it ('should return a _functionOps that throws an error when the passed in value doesn\'t match one of ' +
    ...
    it ('should return a _functionOps that does not throw an error when the passed in value matches one of ' +
        'the "one-or-more" passed in types.', function () {
        let errorIfNotType = errorIfNotTypeFactory('someContextName');

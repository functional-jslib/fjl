...
describe ('data.DoublyLinkedList', function () {
    ...
    describe('#DLLNode', function () {
        describe('Construction', function () {
            it ('should construct `DLLNode` when called as a _functionOps', function () {
                let dllNode = DLLNode();
            ...
            it ('should construct `DLLNode` when called as a _functionOps with an `id_.js` and a `value` value', function () {
                let id = 0,
                    value = 'some-value',
            ...
            it ('should construct `DLLNode` when called with `new` with an `id_.js` and a `value` value', function () {
                let id = 0,
                    value = 'some-value',

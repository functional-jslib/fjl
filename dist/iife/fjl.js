...
var concat$2 = fPureTakesOneOrMore('concat');
var join = fPureTakesOne('join');
var slice$1 = fPureTakes2('slice');
...
// Exported internals
var append = concat$1;
var appendMany = function appendMany(x) {
    for (var _len = arguments.length, args = Array(_len > 1 ? _len - 1 : 0), _key = 1; _key < _len; _key++) {
        args[_key - 1] = arguments[_key];
    }
    ...
    if (!lenArgs) {
        return sliceFrom(0, x);
    }
    return concat$1.apply(undefined, [x].concat(args));
};

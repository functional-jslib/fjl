define(['exports', './object/typeOf', './object/is', './function/curry'], function (exports, _typeOf, _is, _curry) {
    'use strict';
     ...
     * @private
     */
    typeRefsToStringOrError = exports.typeRefsToStringOrError = types => types.length ? types.map(type => `\`${(0, _is.toTypeRefName)(type)}\``).join(', ') : '',
     ...
     * @private
     */
    _getErrorIfNotTypeThrower = exports._getErrorIfNotTypeThrower = (errorMessageCall, typeChecker = _is.isOfType) => (ValueType, contextName, valueName, value, messageSuffix = null) => {
        const expectedTypeName = (0, _is.toTypeRef)(ValueType),
     ...
     * @private
     */
    _getErrorIfNotTypesThrower = exports._getErrorIfNotTypesThrower = (errorMessageCall, typeChecker = _is.isOfType) => (valueTypes, contextName, valueName, value, messageSuffix = null) => {
        const expectedTypeNames = valueTypes.map(_is.toTypeRef),
     ...
     */
    getErrorIfNotTypesThrower = exports.getErrorIfNotTypesThrower = errorMessageCall => (0, _curry.curry)(_getErrorIfNotTypesThrower(errorMessageCall)),

define(['exports', '../uncurried/objectOps/is_', '../uncurried/functionOps/curry_'], function (exports, _is_, _curry_) {
  'use strict';
   ...
   * @returns {Boolean}
   */
  notEmptyAndOfType = exports.notEmptyAndOfType = (0, _curry_.curry)((type, value) => !(0, _is_.isEmpty)(value) && isType(type, value))

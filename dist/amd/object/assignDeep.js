define(['exports', './is', '../jsPlatform/object', '../function/curry'], function (exports, _is, _object, _curry) {
    'use strict';
     ...
     * @returns {Object}
     */
    assignDeep = exports.assignDeep = (0, _curry.curry2)((obj0, ...objs) => !obj0 ? obj0 : objs.reduce((topAgg, obj) => !obj ? topAgg : (0, _object.keys)(obj).reduce((agg, key) => {

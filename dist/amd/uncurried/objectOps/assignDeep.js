define(['exports', './is', '../jsPlatform/objectOpsUncurried'], function (exports, _is, _objectOpsUncurried) {
    'use strict';
     ...
     * @returns {Object}
     */
    assignDeep = exports.assignDeep = (obj0, ...objs) => objs.reduce((topAgg, obj) => (0, _objectOpsUncurried.keys)(obj).reduce((agg, key) => {

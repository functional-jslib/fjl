define(['exports', '../_objectOps/_utils'], function (exports, _utils) {
     ...
     * @returns {Boolean}
     */
    _instanceOf = exports._instanceOf = (instanceConstructor, instance) => instance instanceof instanceConstructor,
     ...
     * @returns {Object}
     */
    _assign = exports._assign = (() => Object.assign ? (obj0, ...objs) => Object.assign(obj0, ...objs) : (obj0, ...objs) => objs.reduce((topAgg, obj) => {

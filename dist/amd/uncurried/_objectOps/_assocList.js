define(['exports', './_is'], function (exports, _is) {
   ...
   * @returns {Array.<*, *>}
   */
  toAssocList = exports.toAssocList = obj => Object.keys(obj).map(key => (0, _is.isObject)(obj[key]) ? [key, toAssocList(obj[key])] : [key, obj[key]]),
   ...
   * @returns {any[]} - Associated list
   */
  _toAssocListOnKeys = exports._toAssocListOnKeys = (keys, obj) => Object.keys(obj).map(key => keys.includes(key) && (0, _is.isObject)(obj[key]) ? [key, _toAssocListOnKeys(keys, obj[key])] : [key, obj[key]]),
   ...
   * @returns {Object}
   */
  fromAssocList = exports.fromAssocList = xs => xs.reduce((agg, [key, value]) => {
   ...
   * @returns {Object}
   */
  _fromAssocListOnKeys = exports._fromAssocListOnKeys = (keys, xs) => xs.reduce((agg, [k, value]) => {

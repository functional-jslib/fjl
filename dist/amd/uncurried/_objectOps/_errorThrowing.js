define(['exports', './_typeOf', './_is', '../_functionOps/_curry'], function (exports, _typeOf, _is, _curry) {
  'use strict';
   ...
   * @returns {Boolean}
   */
  isCheckableType = exports.isCheckableType = type => (0, _is.isString)(type) || (0, _is.isFunction)(type),
   ...
   */
  _errorIfNotCheckableType = exports._errorIfNotCheckableType = (contextName, type) => {
   ...
   * @private
   */
  getTypeName = exports.getTypeName = type => _errorIfNotCheckableType('getTypeName', type) && (0, _is.isString)(type) ? type : type.name,
   ...
   * @returns {Boolean}
   */
  _defaultTypeChecker = exports._defaultTypeChecker = (Type, value) => (0, _is._isType)(getTypeName(Type), value) || (0, _is.isFunction)(Type) && (0, _is.isset)(value) && value instanceof Type,
   ...
   * @private
   */
  multiTypesToString = exports.multiTypesToString = types => types.length ? types.map(type => `\`${getTypeName(type)}\``).join(', ') : '',

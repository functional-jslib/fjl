define(['exports', '../_jsPlatform/_object', './_prop', './_typeOf', './_is', './_of', './_assignDeep', './_setTheory', './_console', './_errorThrowing', './_jsonClone', './_toArray', './_assocList'], function (exports, _object, _prop, _typeOf, _is, _of, _assignDeep, _setTheory, _console, _errorThrowing, _jsonClone, _toArray, _assocList) {
  'use strict';

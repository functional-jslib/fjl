define(['exports', './list', './jsPlatform/string', './uncurried/_function/_compose', './jsPlatform/array', './uncurried/_object/_errorThrowing'], function (exports, _list, _string, _compose, _array, _errorThrowing) {
    'use strict';

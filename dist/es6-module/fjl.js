...
const isPromise = value => isType$1('Promise', value);
...
const notEmptyAndOfType$1 = (type, value) => !isEmpty(value) && isType$1(type, value);
...
const notEmptyAndOfType$$1 = curry(notEmptyAndOfType$1);

...
import { curry, trampoline } from "../function";
/**
...
unWrapMonadByType = (Type, monad) => {
    ...
    const [unWrapper, tailCallName] = getMonadUnWrapper(Type), unwrap = trampoline(unWrapper, tailCallName);
    return unwrap(monad);
};

(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', './curry', './is', './typeOf', './objFnOperators', './arrayFnOperators'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('./curry'), require('./is'), require('./typeOf'), require('./objFnOperators'), require('./arrayFnOperators'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.curry, global.is, global.typeOf, global.objFnOperators, global.arrayFnOperators);
        global.fnOperators = mod.exports;
    }
})(this, function (exports, _curry, _is, _typeOf, _objFnOperators, _arrayFnOperators) {
    /**

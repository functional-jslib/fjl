(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', './_aggregation', '../_jsPlatform/_function', '../_jsPlatform/_list', '../_jsPlatform/_object', '../../boolean', './_map'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('./_aggregation'), require('../_jsPlatform/_function'), require('../_jsPlatform/_list'), require('../_jsPlatform/_object'), require('../../boolean'), require('./_map'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global._aggregation, global._function, global._list, global._object, global.boolean, global._map);
        global._utils = mod.exports;
    }
})(this, function (exports, _aggregation, _function, _list, _object, _boolean, _map2) {
    'use strict';
    ...
    reduceRightUntil = exports.reduceRightUntil = function reduceRightUntil(pred, op, agg, arr) {
        ...
        return reduceUntil(_boolean.alwaysFalse, // until-predicate
        operation, // operation
        agg, // aggregator
        arr);
    },
    ...
    reduceRight = exports.reduceRight = function reduceRight(operation, agg, arr) {
        return reduceRightUntil(_boolean.alwaysFalse, // until-predicate
        operation, // operation
        agg, // aggregator
        arr);
    },

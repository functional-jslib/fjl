(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', './apply', '../jsPlatform/array_'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('./apply'), require('../jsPlatform/array_'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.apply, global.array_);
    global.negate = mod.exports;
  }
})(this, function (exports, _apply, _array_) {
  'use strict';

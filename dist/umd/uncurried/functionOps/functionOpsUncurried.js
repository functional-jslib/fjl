(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', './apply', './call', './compose', './curry', './curry_', './flip', './id', './negate', './until'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('./apply'), require('./call'), require('./compose'), require('./curry'), require('./curry_'), require('./flip'), require('./id'), require('./negate'), require('./until'));
  } else {
    var mod = {
      exports: {}
    };

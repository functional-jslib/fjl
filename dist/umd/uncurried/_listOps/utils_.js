(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', './aggregation_', '../_jsPlatform/function_', '../_jsPlatform/list_', '../_jsPlatform/object_', '../../booleanOps', './map_'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('./aggregation_'), require('../_jsPlatform/function_'), require('../_jsPlatform/list_'), require('../_jsPlatform/object_'), require('../../booleanOps'), require('./map_'));
    } else {
        var mod = {
            exports: {}
        };

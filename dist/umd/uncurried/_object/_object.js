(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', '../_jsPlatform/_object', './_prop', './_typeOf', './_is', './_of', './_fromNamespace', './_assignDeep', './_setTheory', './_console', './_errorThrowing', './_jsonClone', './_toArray', './_assocList'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('../_jsPlatform/_object'), require('./_prop'), require('./_typeOf'), require('./_is'), require('./_of'), require('./_fromNamespace'), require('./_assignDeep'), require('./_setTheory'), require('./_console'), require('./_errorThrowing'), require('./_jsonClone'), require('./_toArray'), require('./_assocList'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global._object, global._prop, global._typeOf, global._is, global._of, global._fromNamespace, global._assignDeep, global._setTheory, global._console, global._errorThrowing, global._jsonClone, global._toArray, global._assocList);

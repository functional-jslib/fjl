(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', './_assignDeep', '../_jsPlatform/_object', '../_list/_list'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('./_assignDeep'), require('../_jsPlatform/_object'), require('../_list/_list'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global._assignDeep, global._object, global._list);
        global._setTheory = mod.exports;
    }
})(this, function (exports, _assignDeep2, _object, _list) {
    'use strict';

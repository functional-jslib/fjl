(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', './is', '../jsPlatform/objectOpsUncurried', '../functionOps/apply'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('./is'), require('../jsPlatform/objectOpsUncurried'), require('../functionOps/apply'));
    } else {
        var mod = {
            exports: {}
        };

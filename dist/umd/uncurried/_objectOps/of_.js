(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', './is_', '../_jsPlatform/object_', '../_jsPlatform/function_'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('./is_'), require('../_jsPlatform/object_'), require('../_jsPlatform/function_'));
    } else {
        var mod = {
            exports: {}
        };

(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', './is_', '../_jsPlatform/object_'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('./is_'), require('../_jsPlatform/object_'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.is_, global.object_);
        global.assignDeep_ = mod.exports;
    }
})(this, function (exports, _is_, _object_) {
    'use strict';

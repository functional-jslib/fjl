(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', '../_jsPlatform/_object', './_prop', './_typeOf', './_is', './_of', './_assignDeep', './_setTheory'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('../_jsPlatform/_object'), require('./_prop'), require('./_typeOf'), require('./_is'), require('./_of'), require('./_assignDeep'), require('./_setTheory'));
    } else {
        var mod = {
            exports: {}
        };

(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', '../objectOps/of_', './aggregation_', '../jsPlatform/object_'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('../objectOps/of_'), require('./aggregation_'), require('../jsPlatform/object_'));
    } else {
        var mod = {
            exports: {}
        };

(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', './listOpsUncurriedAggregation', '../jsPlatform/functionOpsUncurried', '../jsPlatform/listOpsUncurried', '../jsPlatform/objectOpsUncurried', '../../booleanOps/booleanOps', './map'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('./listOpsUncurriedAggregation'), require('../jsPlatform/functionOpsUncurried'), require('../jsPlatform/listOpsUncurried'), require('../jsPlatform/objectOpsUncurried'), require('../../booleanOps/booleanOps'), require('./map'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.listOpsUncurriedAggregation, global.functionOpsUncurried, global.listOpsUncurried, global.objectOpsUncurried, global.booleanOps, global.map);
        global.listOpsUncurriedUtils = mod.exports;
    }
})(this, function (exports, _listOpsUncurriedAggregation, _functionOpsUncurried, _listOpsUncurried, _objectOpsUncurried, _booleanOps, _map) {
    'use strict';

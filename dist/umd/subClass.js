(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', './is', './not', './objCombinators', './assign'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('./is'), require('./not'), require('./objCombinators'), require('./assign'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.is, global.not, global.objCombinators, global.assign);
        global.subClass = mod.exports;
    }
})(this, function (exports, _is, _not, _objCombinators, _assign) {
    'use strict';

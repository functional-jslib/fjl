(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', './object/typeOf', './function/curry'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('./object/typeOf'), require('./function/curry'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.typeOf, global.curry);
        global.utils = mod.exports;
    }
})(this, function (exports, _typeOf, _curry) {
    'use strict';

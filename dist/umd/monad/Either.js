(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', '../is', '../operators', '../curry', '../subClass', './../functor/Bifunctor', './Monad'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('../is'), require('../operators'), require('../curry'), require('../subClass'), require('./../functor/Bifunctor'), require('./Monad'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.is, global.operators, global.curry, global.subClass, global.Bifunctor, global.Monad);
        global.Either = mod.exports;
    }
})(this, function (exports, _is, _operators, _curry, _subClass, _Bifunctor, _Monad) {
    /**
    ...
    var Left = exports.Left = (0, _subClass.subClass)(_Monad2.default, {
        ...
        either = exports.either = (0, _curry.pureCurry2)(function (leftCallback, rightCallback, monad) {

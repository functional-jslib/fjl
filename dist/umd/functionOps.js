(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', './uncurried/_functionOps/_curry', './uncurried/_functionOps/__curry', './uncurried/_functionOps/_negate', './uncurried/_functionOps/_id', './uncurried/_functionOps/_compose', './uncurried/_jsPlatform/_jsPlatform', './uncurried/_functionOps/_until', './uncurried/_functionOps/_flip'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('./uncurried/_functionOps/_curry'), require('./uncurried/_functionOps/__curry'), require('./uncurried/_functionOps/_negate'), require('./uncurried/_functionOps/_id'), require('./uncurried/_functionOps/_compose'), require('./uncurried/_jsPlatform/_jsPlatform'), require('./uncurried/_functionOps/_until'), require('./uncurried/_functionOps/_flip'));
    } else {
        var mod = {
            exports: {}
        };

(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', './curry', './is', './typeOf', './objOperators', './arrayOperators'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('./curry'), require('./is'), require('./typeOf'), require('./objOperators'), require('./arrayOperators'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.curry, global.is, global.typeOf, global.objOperators, global.arrayOperators);
        global.operators = mod.exports;
    }
})(this, function (exports, _curry, _is, _typeOf, _objOperators, _arrayOperators) {
    /**

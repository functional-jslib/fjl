(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', './is', '../uncurried/jsPlatform/objectUncurried', '../functionOps/apply'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('./is'), require('../uncurried/jsPlatform/objectUncurried'), require('../functionOps/apply'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.is, global.objectUncurried, global.apply);
        global.of = mod.exports;
    }
})(this, function (exports, _is, _objectUncurried, _apply) {
    'use strict';

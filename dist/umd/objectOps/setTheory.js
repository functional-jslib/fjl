(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', '../functionOps/curry', '../uncurried/jsPlatform/object_', '../uncurried/objectOps/assignDeep_', '../listOps'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('../functionOps/curry'), require('../uncurried/jsPlatform/object_'), require('../uncurried/objectOps/assignDeep_'), require('../listOps'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.curry, global.object_, global.assignDeep_, global.listOps);
        global.setTheory = mod.exports;
    }
})(this, function (exports, _curry, _object_, _assignDeep_, _listOps) {
    'use strict';

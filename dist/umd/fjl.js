(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', './assign', './compose', './curry', './typeOf', './is', './functionOps', './objectOps', './arrayOps', './operators', './stringOps', './generated/version'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('./assign'), require('./compose'), require('./curry'), require('./typeOf'), require('./is'), require('./functionOps'), require('./objectOps'), require('./arrayOps'), require('./operators'), require('./stringOps'), require('./generated/version'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.assign, global.compose, global.curry, global.typeOf, global.is, global.functionOps, global.objectOps, global.arrayOps, global.operators, global.stringOps, global.version);
        global.fjl = mod.exports;
    }
})(this, function (exports, _assign, _compose, _curry, _typeOf, _is, _functionOps, _objectOps, _arrayOps, _operators, _stringOps, _version) {
    'use strict';

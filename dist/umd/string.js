(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', './list', './jsPlatform/string', './function/compose', './jsPlatform/array', './object/errorThrowing'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('./list'), require('./jsPlatform/string'), require('./function/compose'), require('./jsPlatform/array'), require('./object/errorThrowing'));
    } else {
        var mod = {
            exports: {}
        };

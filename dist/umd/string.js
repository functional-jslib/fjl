(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', './list', './jsPlatform/string', './uncurried/_function/_compose', './jsPlatform/array', './uncurried/_object/_errorThrowing'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('./list'), require('./jsPlatform/string'), require('./uncurried/_function/_compose'), require('./jsPlatform/array'), require('./uncurried/_object/_errorThrowing'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.list, global.string, global._compose, global.array, global._errorThrowing);
        global.string = mod.exports;
    }
})(this, function (exports, _list, _string, _compose, _array, _errorThrowing) {
    'use strict';

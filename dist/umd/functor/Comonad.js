(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['module', 'exports', './Extend', '../subClass'], factory);
    } else if (typeof exports !== "undefined") {
        factory(module, exports, require('./Extend'), require('../subClass'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod, mod.exports, global.Extend, global.subClass);
        global.Comonad = mod.exports;
    }
})(this, function (module, exports, _Extend, _subClass) {
    /**

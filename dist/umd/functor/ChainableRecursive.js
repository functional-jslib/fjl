(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', './Chainable', './../subClass'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('./Chainable'), require('./../subClass'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.Chainable, global.subClass);
        global.ChainableRecursive = mod.exports;
    }
})(this, function (exports, _Chainable, _subClass) {
    /**

(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', './Functor', './Foldable', './../subClass'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('./Functor'), require('./Foldable'), require('./../subClass'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.Functor, global.Foldable, global.subClass);
        global.Traversable = mod.exports;
    }
})(this, function (exports, _Functor, _Foldable, _subClass) {
    /**
